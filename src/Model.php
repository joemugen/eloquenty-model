...
use JoeMugen\EloquentyModel\Contracts\CastsInboundAttributes;
...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable
{
     ...
     * @return $this
     *
     * @throws \JoeMugen\EloquentyModel\MassAssignmentException
     */
     ...
     * @param bool $exists
     *
     * @return \JoeMugen\EloquentyModel\Model
     */
    ...
    {
        return with(new static)->fill(Arr::except($this->attributes, $except ?? []));
    }
